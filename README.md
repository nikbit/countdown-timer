...
> Apri questa pagina in [https://nikbit.github.io/countdown-timer/](https://nikbit.github.io/countdown-timer/)
...
* cerca **https://github.com/nikbit/countdown-timer** ed importa

## Modifica questo progetto ![Badge stato build](https://github.com/nikbit/countdown-timer/workflows/MakeCode/badge.svg)

Per modificare questa repository in MakeCode.

* apri [https://makecode.microbit.org/](https://makecode.microbit.org/)
* clicca su **Importa** quindi fai clic su **Importa INDIRIZZO**
* incolla **https://github.com/nikbit/countdown-timer** e clicca importa
...
![Un'immagine renderizzata dei blocchi](https://github.com/nikbit/countdown-timer/raw/master/.github/makecode/blocks.png)
